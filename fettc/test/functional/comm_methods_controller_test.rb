...
class CommMethodsControllerTest < ActionController::TestCase
  ...
  test "should create comm_method" do
    assert_difference('CommMethod.count') do
      post :create, comm_method: { address: @comm_method.address, frequency: @comm_method.frequency, method: @comm_method.method, user_id: @comm_method.user_id }
    end
  ...
  test "should update comm_method" do
    put :update, id: @comm_method, comm_method: { address: @comm_method.address, frequency: @comm_method.frequency, method: @comm_method.method, user_id: @comm_method.user_id }
    assert_redirected_to comm_method_path(assigns(:comm_method))
  end
